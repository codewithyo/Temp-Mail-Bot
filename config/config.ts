export const BOT_TOKEN = Deno.env.get("8318603696:AAFYPNsibQR0xmsHLwvvxsNiYILlzXUIivA")!;
console.log(BOT_TOKEN);
export const CHANNEL_USERNAME = (Deno.env.get("@HRtempmail") || "@HRtempmail").replace(/^@?/, "@");
